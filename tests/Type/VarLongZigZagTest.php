...
class VarLongZigZagTest extends TestCase
{
    /**
     * @var VarLongZigZag
     */
    ...
    {
        $this->field = new VarLongZigZag(new BinaryProtocol(), []);
    }
    ...
    public function testGetSizeThrowsExceptionWithoutValue(): void
    {
        ...
        $this->expectExceptionMessage('VarLongZigZag size depends on value itself and it should be int type');
        $this->field->getSize();
    }
