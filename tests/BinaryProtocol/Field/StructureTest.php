...
class StructureTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->field     = new Structure(new BinaryProtocol(), [
    ...
    public function testConstructorRequiresClassOption(): void
    {
        ...
        $this->expectExceptionMessage('Structure expects the `class` field to be specified');
        new Structure(new BinaryProtocol(), []);
    }

    public function testConstructorRequiresClassToBeStructureInterface(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Structure should implement `StructureInterface`');
        new Structure(new BinaryProtocol(), [
