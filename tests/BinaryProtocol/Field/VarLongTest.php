...
class VarLongTest extends TestCase
{
    /**
     * @var VarLong
     */
    ...
    {
        $this->field = new VarLong(new BinaryProtocol(), []);
    }
    ...
    public function testGetSizeThrowsExceptionWithoutValue(): void
    {
        ...
        $this->expectExceptionMessage('VarLong size depends on value itself and it should be int type');
        $this->field->getSize();
    }
